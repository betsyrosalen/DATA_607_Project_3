...
* __WorkToolsSelect__: This was a "select all that apply"" variable with a list of various data science tools, technologies, and languages. Survey takers identified which tools were utilized in their work and the results were stored in this comma seperated variable.
