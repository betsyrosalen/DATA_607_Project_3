...
Plus a few basic demographic fields and a focus only on respondents who are located in the US
...
**30%** of or survey respondents call themselves **"Data Scientists"** 

**20%** call themselves either **"Scientist/Researcher"** or **"Software Developer/Software Engineer"**

50% of our survey respondents fall in these three categories with the other 50% in other roles
...
**55% are "focused on learning mostly data science skills"** regardless of whether or not they are enrolled in an academic program
...
'Learners' - top 3 best ways to learn data science are through **Courses**, **Projects** and **College**  
...
Employed Data Scientists - **Projects** and **Courses** belong in the top 3, but put **College in 5th place** (vs. 3rd)

Much greater importance on **Friends** - 46.5% say that Friends are "Very useful" and 97.5% say that Friends are either "Somewhat useful" or "Very useful"

**'Learners' put Friends at absolute bottom of their list**. Only 17.6% said that they are are "Very useful"
...
**Python** near the top of the list with **63.6%** of respondents saying that it is "Necessary"

**R** is further down the list with only **35%** saying that R is "Necessary"

**Data Visualization** comes in only slightly above R.  **Only 39% say it is "Necessary"** and **8% say it is "Unnecessary"**
...
**75.4%** say that they use **Python** either "Often" or "Most of the time" 

**63.6%** say that they use **R** either "Often" or "Most of the time"
...
0% say that they use it "Rarely" and only 8.5% say that they only use it "Sometimes"

**Data Visualization is by far the most frequently used method or tool** for working Data Science Professionals 

**Only 38.8% of 'Learners' said that they thought Visualizations were a "Necessary" job skill to learn!**
