...
Comparing the answers of 'Learners' vs. employed Data Scientists may give us some insight into which skills each group values most and whether or not they are in agreement.
...
A large portion of the Kaggle data collected is in the form of Likert scales

Likert scales ask respondents to place the value, importance, or frequency of use of certain skills, tools and methods on a 3-4 point scale.  

We analyzed for differences between what 'Learners' thought was important to them vs. what employed data scientists say they are using in the field.  
...
About 105 variables fall into 5 likert scale categories describing:

  - "Learning Platform Usefulness" (which was asked of both learners and employed data scientists), 
  - "Job Skill Importance" (which only unemployed learners were asked), 
  - "Work Tools Frequency" and "WorkMethodsFrequency" (which only employed data scientists were asked to answer)
  
We narrowed down the data to include only these as well as a few more basic demographic fields to get a sense of who the respondents are.

We also chose to focus only on respondents who are located in the US since international cultural and technological differences may skew results. 
...
The Kaggle survey asked respondents if they were learning data science and their student status.  
...
Employed Data Scientists agree with unemployed 'Learners' that Projects and Courses belong in the top 3, but put College in 5th place (vs. 3rd).  

Data Scientists placed a much greater importance on Friends with about 46.5% saying that Friends are "Very useful" and 97.5% saying that Friends are either "Somewhat useful" or "Very useful".

'Learners' by comparison put Friends at absolute bottom of their list with only 17.6% saying that they are are "Very useful".
...
'Learners' put Python at the top of their list of Job Skills with 63.6% of respondents saying that it is "Necessary"

R is surprisingly further down the list with only a little more than half as many respondents saying that R is "Necessary" compared to Python

"Data Visualization" comes in only slightly above R with 39% saying that it is "Necessary" but actually slightly lower in terms of overall importance with 8% saying it is "Unnecessary".
...
Python is high on the list of tools that working Data Scientists use with 75.4% of users saying that they use it either "Often" or "Most of the time" 

2 of the the top three tools used in the field aren't even on the list of Job Skills 'Learners' were asked to evaluate.

R comes in slightly lower than Python with 63.6% of users saying that they use it either "Often" or "Most of the time"
...
Data Visualization is at the top of the list.  With nobody saying that they use it "Rarely" and only 8.5% saying that they only use it "Sometimes".  

It is by far the most frequently used method or tool for working Data Science Professionals 

Remember only 38.8% of 'Learners' said that they thought Visualizations were a "Necessary" job skill to learn!  
