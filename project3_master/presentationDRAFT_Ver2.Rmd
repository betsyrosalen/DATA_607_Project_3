---
title: "DATA 607 Project 3 Presentation"
...
## [Kaggle ML and Data Science Survey, 2017](https://www.kaggle.com/kaggle/kaggle-survey-2017)
...
- 16716 total Kaggle respondents
- 13610 males (84%)
- 2778 females (16%)
- About 5 (~4.8) times as many males as females
- Age peak at 25 for both males and females
- Median at about 30
...
- 37.75% of time spent in Data Acquisition
- 19.23% on Model Building (2nd highest)
- only 10.23% in production activities
...
## What are the most frequently used data science (DS) methods by those writing code in DS professions? 

<br>

## Do those relate to formal educational attainment?
...
- classified as code writers
- employed in some capacity working in data science
- endorsed at least one data science skill on the question, "At work, which data science methods do you use?
...
### Frequency with which data science methods were endorsed by a total of 7,773 respondents.  

<table>
<tr>
<td valign="top">
- Nearly 2/3 endorsed the first place skill, data visualization
- Over half endorse logistic regression
- Just shy of half endorse cross-validation and decision trees
</td>
<td>
...
### Frequency of endorsements for the data science methods
...
<tr>
<td valign="top">
Are there rare but essential methods in data science?

Respondents were asked if they use each method Rarely, Sometimes, Often, or Most of the time.  We converted these to numeric values in order to graph a score and average the categorical responses.

Data visualization was the skill indicated to be used the most frequently.
...
- Data science methods used by code writers does not seem to differ given the educational level.  
- Data visualization remains the most frequently endorsed data science method for the majority of educational groups. 
