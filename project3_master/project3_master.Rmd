...
linkMC<-"https://raw.githubusercontent.com/betsyrosalen/DATA_607_Project_3/master/rawdata/multipleChoiceResponses.csv"
#importing MC items
MC<-read_csv (linkMC)
dim(MC)
...
```{r message=FALSE ,warning=FALSE}
# link_conversion<-"https://raw.githubusercontent.com/betsyrosalen/DATA_607_Project_3/master/rawdata/conversionRates.csv"
# #importing MC items
...
```{r}
df<-MC %>%
select (WorkToolsSelect, id,Country,JobFunctionSelect,CurrentJobTitleSelect,LanguageRecommendationSelect,LearningPlatformSelect,FormalEducation,LearningPlatformSelect:LearningPlatformUsefulnessYouTube,CompensationAmount)
colnames(df)
```
